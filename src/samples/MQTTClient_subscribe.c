...
int main(void)
{
   ...
   /* while(1)
    ...
    cJSON_AddStringToObject(root, "msgtype", "outthhold");
    ...
    cJSON_AddStringToObject(data, "gwID", "1");
    cJSON_AddStringToObject(data, "deviceid", "4");
    cJSON_AddStringToObject(data, "devicetype", "1");
    cJSON_AddStringToObject(data, "item", "2");
    cJSON_AddStringToObject(data, "timestamp", datetime());
    char text[100];
    char str1[]="userid =1&token=1&timestamp=";
    char *str2=datetime();
    char str3[]="&nonce=";
    char *str4=ran();
    char *str5="&data=";
    char *str6="gwID=1deviceid=4devicetype=1item=2&timestamp=";
    strcpy(text,str1);
    strcat(text,str2);
    strcat(text,str3);
    strcat(text,str4);
